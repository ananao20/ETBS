...
class DoctorView(APIView):
    ...
    #Retrieves Doctor's data from the database
    ...
    #Delete exisitng Data from database 
...
class AppointmentView(APIView):
    def post(self, request):
        ...
        #retrieves the doctor and patient associated with the appointment using their IDs
...
#retrieves doctor's appointment
@api_view(['GET'])
